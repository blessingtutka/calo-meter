...
//                 appId: reclaimprocess.env.appId,
//                 secret: reclaimprocess.env.appSecret,
//                 providerId: reclaimprocess.env.providerId,
//             });
...
//                 }
//             } else {
//                 Alert.alert('Error', error instanceof Error ? error.message : 'An unknown error occurred during the verification flow');
//             }
//         } finally {
//             setLoading(false);
//         }
